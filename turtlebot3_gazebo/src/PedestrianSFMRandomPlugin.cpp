...
void PedestrianSFMRandomPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  if (_sdf->HasElement("velocity"))
    ...
    this->sfmActor.desiredVelocity = 0.9;
  ...
  if (_sdf->HasElement("obstacle_weight"))
    ...
    this->sfmActor.params.forceFactorObstacle = 10.0;
  ...
  if (_sdf->HasElement("social_weight"))
    ...
    this->sfmActor.params.forceFactorSocial = 15;
